...
<div class="main">
    <div class="container a-container" id="a-container">
        <form class="form" action="../index.php?action=dangki" id="a-form" method="post" action="../index.php?action=sale">
            ...
            <span
                    class="form__span">or use email for registration</span>
            <input id="name" name="name" class="form__input" type="text" placeholder="Name">
            <input id="username" name="username" class="form__input" type="text" placeholder="UserName">
            <input id="password" name="pass" class="form__input" type="password" placeholder="Password">
            <input id="age" name="age" class="form__input" type="text" placeholder="Age">
            <input id="email" name="email" class="form__input" type="text" placeholder="Email">
            <input id="sex" name="gender" class="form__input" type="text" placeholder="Sex">
            <input id="address"name="address" class="form__input" type="text" placeholder="Address">
            <input id="phone" name="phone" class="form__input" type="text" placeholder="Phone number">

            <button onclick="showDialog()" name="btn-reg" class="form__button button submit" front-size="10px" height="50px">SIGN UP
            </button>
        </form>
    </div>
    <div class="container b-container" id="b-container">
        <form class="form" id="b-form" method action>
            ...
            <span
                    class="form__span">or use your email account</span><input
                class="form__input" type="text" name="email" placeholder="Email"><input
                class="form__input" name="password" type="password"
                placeholder="Password"><a class="form__link">Forgot your
            password?</a>
            <button
                    class="form__button button submit" name="btn-log">SIGN IN
            </button>
        </form>
    </div>
    <div class="switch" id="switch-cnt">
        ...
        <div class="switch__container is-hidden" id="switch-c2">
            ...
            <p class="switch__description description">Enter your
                personal details and start journey with us</p>
            <button
                    class="switch__button button switch-btn">SIGN UP
            </button>
        </div>
    </div>
    <dialog id="dialog-info">
        <output id="dialog-content"></output>
...
<script>
    ...
    function showDialog() {
        ...
        const dialogContent = `Name: ${name}<br>Userame: ${username}<br>Age: ${age}
                            <br>Email: ${email}<br>Sex: ${sex}<br>Address: ${address}<br>Phone: ${phone}`;
    ...
    function validateForm() {
        ...
        if (username == "" || password == "") {
            alert("Vui lòng nhập đầy đủ thông tin đăng nhập hoặc đăng ký.");
            return false;
        }
    }
</script>

...
<body>
<form id="sign" action="../index.php?action=dangki" method="post" style="border:1px solid #ccc" onsubmit="return kiemtra()" onsubmit="matchpass()">
<div class="container">
    ...
    <br>
    <input name="password" type="password"  id="password" placeholder="PassWord..."autocomplete="password">
    <h4 id="baoloi"></h4>
    <br>
    ...
    <label>Email: </label>
    <br>
    <input name="email" type="email" id="mail" placeholder="Email..." autocomplete="email">
    <h4 id="baoloi"></h4>
    <br>
    <label>Giới tính: </label>
        <div>
            ...
            <div class="form-check">
                ...
                <label class="form-check" for="Nữ">NỮ</label>
            </div>
        </div>
    <label>Địa chỉ: </label>
    <br>
    ...
    <br>
    <hr>
    <h3>-- Đã có tài khoản - <a href="../index.php?action=dangnhap">Đăng nhập</a></h3>
</form>
</div>
<script>
    function kiemtra(){
